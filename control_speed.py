...
def main():
    ...
    # Widgets
    tk.Label(window, text="Velocity (1pos/s)").pack(pady=(4, 0))
    velocity_slider = tk.Scale(window, from_=0.1, to=10.0, resolution=0.05,
                           orient=tk.HORIZONTAL, length=300)
    velocity_slider.set(node.execution_velocity)
    ...
    def on_send_command():
        try:
            ...
            t = abs(pos - node.current_position) / float(velocity_slider.get())
